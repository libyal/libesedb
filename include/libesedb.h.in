 ...
 * Returns 1 if successful or -1 on error
 *
 * This function is deprecated use libesedb_file_get_number_of_tables instead
 */
LIBESEDB_DEPRECATED \
LIBESEDB_EXTERN \
...
/* -------------------------------------------------------------------------
 * Table functions - deprecated
 * ------------------------------------------------------------------------- */

/* Retrieves the amount of columns in the table
 * Returns 1 if successful or -1 on error
 *
 * This function is deprecated use libesedb_table_get_number_of_columns instead
 */
LIBESEDB_DEPRECATED \
LIBESEDB_EXTERN \
 ...
 * Returns 1 if successful or -1 on error
 *
 * This function is deprecated use libesedb_table_get_number_of_indexes instead
 */
LIBESEDB_DEPRECATED \
LIBESEDB_EXTERN \
 ...
 * Returns 1 if successful or -1 on error
 *
 * This function is deprecated use libesedb_table_get_number_of_records instead
 */
LIBESEDB_DEPRECATED \
LIBESEDB_EXTERN \
 ...
 * Returns 1 if successful or -1 on error
 *
 * This function is deprecated use libesedb_record_get_number_of_values instead
 */
LIBESEDB_DEPRECATED \
LIBESEDB_EXTERN \
 ...
 * Returns 1 if successful, 0 if value is NULL or -1 on error
 *
 * This function is deprecated use libesedb_record_get_value_floating_point_32bit
 * or libesedb_record_get_value_floating_point_64bit instead
 */
LIBESEDB_DEPRECATED \
LIBESEDB_EXTERN \
...
/* Retrieves the amount of values in a multi value
 * Returns 1 if successful or -1 on error
 *
 * This function is deprecated use libesedb_multi_value_get_number_of_values instead
 */
LIBESEDB_DEPRECATED \
LIBESEDB_EXTERN \
