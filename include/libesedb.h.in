...
/* -------------------------------------------------------------------------
 * Long functions - deprecated
 * ------------------------------------------------------------------------- */

/* Retrieve the number of data segments
 * Returns 1 if successful or -1 on error
 *
 * This function is deprecated use the libesedb_long_value_get_number_of_data_segments functions instead.
 */
LIBESEDB_DEPRECATED \
LIBESEDB_EXTERN \
 ...
 * Returns 1 if successful or -1 on error
 *
 * This function is deprecated use the libesedb_long_value_get_data_segment functions instead.
 */
LIBESEDB_DEPRECATED \
LIBESEDB_EXTERN \
