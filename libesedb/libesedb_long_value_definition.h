...
#if !defined( _LIBPFF_LONG_VALUE_DEFINITION_H )
#define _LIBPFF_LONG_VALUE_DEFINITION_H
...
typedef struct libesedb_long_value_definition libesedb_long_value_definition_t;

struct libesedb_long_value_definition
{
