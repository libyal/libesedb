...
#if !defined( _ESEDB_TEST_GETOPT_H )
#define _ESEDB_TEST_GETOPT_H
...
#define esedb_test_getopt( argument_count, argument_values, options_string ) \
...
#endif /* !defined( _ESEDB_TEST_GETOPT_H ) */
