...
{
	static char *function     = "esedb_test_get_narrow_source";
...
int esedb_test_get_wide_source(
     ...
     libcerror_error_t **error )
{
	static char *function   = "esedb_test_get_wide_source";
...
int esedb_test_open_file_io_handle(
     ...
     libcerror_error_t **error )
{
	static char *function = "esedb_test_open_file_io_handle";
...
int esedb_test_close_file_io_handle(
     ...
     libcerror_error_t **error )
{
	static char *function = "esedb_test_close_file_io_handle";
	int result            = 0;
