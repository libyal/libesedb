/*
 * Library space_tree_value type test program
 *
 ...
 */
int esedb_test_space_tree_value_initialize(
     void )
{
	...
	space_tree_value = (libesedb_space_tree_value_t *) 0x12345678UL;
	...
	for( test_number = 0;
	     ...
	     test_number++ )
	{
		/* Test libesedb_space_tree_value_initialize with malloc failing
		 */
	...
	for( test_number = 0;
	     ...
	     test_number++ )
	{
		/* Test libesedb_space_tree_value_initialize with memset failing
		 */
...
/* Tests the libesedb_space_tree_value_free function
 * Returns 1 if successful or 0 if not
 */
int esedb_test_space_tree_value_free(
     void )
{
	libcerror_error_t *error = NULL;
	int result               = 0;
...
#endif
{
	...
	ESEDB_TEST_RUN(
	 "libesedb_space_tree_value_initialize",
	 esedb_test_space_tree_value_initialize );
