     ...
     liberror_error_t **error )
{
	     ...
	     record_iterator++ )
	{
		...
		for( value_iterator = 0;
		     ...
		     value_iterator++ )
		{
			if( libesedb_record_get_value_type(
			     record,
			     value_iterator,
			     &value_type,
			     error ) != 1 )
			{
				liberror_error_set(
				 ...
				 LIBERROR_ERROR_DOMAIN_RUNTIME,
				 LIBERROR_RUNTIME_ERROR_GET_FAILED,
				 "%s: unable to retrieve type of value: %d of record: %d.",
				 function,
				 value_iterator + 1,
				 record_iterator + 1 );
				...
				case LIBESEDB_COLUMN_TYPE_BOOLEAN:
					...
					if( result == -1 )
					{
						liberror_error_set(
						 ...
						 LIBERROR_ERROR_DOMAIN_RUNTIME,
						 LIBERROR_RUNTIME_ERROR_GET_FAILED,
						 "%s: unable to retrieve boolean value: %d of record: %d.",
						 function,
						 value_iterator + 1,
						 record_iterator + 1 );
				...
				case LIBESEDB_COLUMN_TYPE_INTEGER_8BIT_UNSIGNED:
					...
					if( result == -1 )
					{
						liberror_error_set(
						 ...
						 LIBERROR_ERROR_DOMAIN_RUNTIME,
						 LIBERROR_RUNTIME_ERROR_GET_FAILED,
						 "%s: unable to retrieve 8-bit value: %d of record: %d.",
						 function,
						 value_iterator + 1,
						 record_iterator + 1 );
				...
				case LIBESEDB_COLUMN_TYPE_INTEGER_16BIT_UNSIGNED:
					...
					if( result == -1 )
					{
						liberror_error_set(
						 ...
						 LIBERROR_ERROR_DOMAIN_RUNTIME,
						 LIBERROR_RUNTIME_ERROR_GET_FAILED,
						 "%s: unable to retrieve 16-bit value: %d of record: %d.",
						 function,
						 value_iterator + 1,
						 record_iterator + 1 );
					...
					{
						if( value_type == LIBESEDB_COLUMN_TYPE_INTEGER_16BIT_SIGNED )
						{
							fprintf(
							 table_file_stream,
							 "%" PRIi16 "",
				...
				case LIBESEDB_COLUMN_TYPE_INTEGER_32BIT_UNSIGNED:
					...
					if( result == -1 )
					{
						liberror_error_set(
						 ...
						 LIBERROR_ERROR_DOMAIN_RUNTIME,
						 LIBERROR_RUNTIME_ERROR_GET_FAILED,
						 "%s: unable to retrieve 32-bit value: %d of record: %d.",
						 function,
						 value_iterator + 1,
						 record_iterator + 1 );
					...
					{
						if( value_type == LIBESEDB_COLUMN_TYPE_INTEGER_32BIT_SIGNED )
						{
							fprintf(
							 table_file_stream,
							 "%" PRIi32 "",
				...
				case LIBESEDB_COLUMN_TYPE_INTEGER_64BIT_SIGNED:
					...
					if( result == -1 )
					{
						liberror_error_set(
						 ...
						 LIBERROR_ERROR_DOMAIN_RUNTIME,
						 LIBERROR_RUNTIME_ERROR_GET_FAILED,
						 "%s: unable to retrieve 64-bit value: %d of record: %d.",
						 function,
						 value_iterator + 1,
						 record_iterator + 1 );
				...
				case LIBESEDB_COLUMN_TYPE_DOUBLE_64BIT:
					...
					if( result == -1 )
					{
						liberror_error_set(
						 ...
						 LIBERROR_ERROR_DOMAIN_RUNTIME,
						 LIBERROR_RUNTIME_ERROR_GET_FAILED,
						 "%s: unable to retrieve floating point value: %d of record: %d.",
						 function,
						 value_iterator + 1,
						 record_iterator + 1 );
				...
				case LIBESEDB_COLUMN_TYPE_LARGE_TEXT:
					...
					if( result == -1 )
					{
						...
						liberror_error_set(
						 ...
						 LIBERROR_ERROR_DOMAIN_RUNTIME,
						 LIBERROR_RUNTIME_ERROR_GET_FAILED,
						 "%s: unable to retrieve size of value string: %d of record: %d.",
						 function,
						 value_iterator + 1,
						 record_iterator + 1 );
						     ...
						     error ) != 1 )
						{
							liberror_error_set(
							 ...
							 LIBERROR_ERROR_DOMAIN_RUNTIME,
							 LIBERROR_RUNTIME_ERROR_GET_FAILED,
							 "%s: unable to retrieve value: %d of record: %d.",
							 function,
							 value_iterator + 1,
							 record_iterator + 1 );
					...
					else if( result != 0 )
					{
						     ...
						     error ) != 1 )
						{
							liberror_error_set(
							 ...
							 LIBERROR_ERROR_DOMAIN_RUNTIME,
							 LIBERROR_RUNTIME_ERROR_GET_FAILED,
							 "%s: unable to retrieve value string: %d of record: %d.",
							 function,
							 value_iterator + 1,
							 record_iterator + 1 );
