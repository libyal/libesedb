...
#if !defined( _ESEDBTOOLS_GETOPT_H )
#define _ESEDBTOOLS_GETOPT_H
...
typedef struct esedbtools_option esedbtools_option_t;

struct esedbtools_option
{
...
#define esedbtools_getopt( argument_count, argument_values, options_string ) \
...
#endif /* !defined( _ESEDBTOOLS_GETOPT_H ) */
